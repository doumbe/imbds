<html>
    ...
    <body>
      ...
      <div id = 'contenu'>
       <!-- <?php //$this->load->view('entreprise/entreprise_menu_gauche.php'); ?>    pour le menu dans l'interface procedure administrative -->
    	...
    	<div id="div_fiche_procedure_administrative" class="bloc_info">
    			<p> <?php echo '<label>'.lang('nom').'</label><span id="fiche_procedure_administrative_nom">'.$procedure_administrative->GMPA_NOM.'</span>';?>
          </p>
    			<p> <?php echo '<label>'.lang('type').'</label><span id="fiche_procedure_administrative_type">'.$procedure_administrative->GMPA_TYPE.'</span>';?></p>
        ...
        <?php echo form_open('entreprise_liste/list_procedure_admin');?>
