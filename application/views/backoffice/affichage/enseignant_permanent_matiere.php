...
<?php $this->load->view('backoffice/script_backoffice.php');?>
    <title><?php echo lang('mbds_back').sprintf(lang('enseignant_per_matiere_year_formation'),$formation, $annee);?></title>
    <script>
  </script>
  </head>
  <body>
...
<div id = 'page'>
      ...
      <div id = 'contenu'>
        ...
        <div id = 'content' class = 'narrowcolumn'>
        	<div id="message">
        <h2>
          <?php echo lang('enseignant_per_matiere') ;?>
        </h2>
      </div>
				<div class="panel-body">
					...
					if(is_null($enseignant_matiere) or empty($enseignant_matiere))
					{
						...
						echo form_open('backoffice_affichage/affichage_choix_enseignant_permanent_matiere');
					...
					?>
						...
						<TABLE id="enseignant_per_matiere" border="1" class="table table-bordered">
							...
							<CAPTION><EM><?php echo sprintf(lang('enseignant_per_matiere_year_formation'),$formation, $annee);?></EM></CAPTION>
							<tr>
							    ...
							    <th style="background-color:#FBEF60;color:#000000;"><?php echo lang('th_composante');?></th>
