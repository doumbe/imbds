...
<html lang="en">
  <head>
    ...
    <title><?php echo lang('mbds_back').lang('gest_seance');?></title>
    <script>
    ...
    <div id = 'page'>
      ...
      <div id = 'contenu'>
        ...
        <div id = 'content' class = 'narrowcolumn'>
          <div id="message">
            <h2><?php echo lang("seance_title");?></h2>
        </div>
          
            <!-- liste des entreprises-->
          <?php echo form_open('backoffice_liste/listSeance');?>
            <div class ="choix">  
...
<?php if(isset($seance) && !is_null($seance) && !empty($seance)){?>
    ...
    <div class ="recherche">
    <!-- liste des entreprises-->
    <?php echo form_open('backoffice_liste/rechercheseance');?>
