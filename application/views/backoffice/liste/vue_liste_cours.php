...
<html lang="en">
  <head>
    ...
    <title><?php echo lang('mbds_back').lang('gest_cours');?></title>
    <script>
  ...
  <body>
    ...
    <?php echo form_open('backoffice_liste/rechercheCours');?>
   ...
   <?php echo anchor("backoffice_ajout/ajouterCours",'<span class="btn btn-danger"><span class="glyphicon glyphicon-plus"></span> '.lang('cours_new').'</span>');?> 
   </div>
       <div class="panel-body">
            ...
            <tbody>
               <?php 
                ...
                <tr>
                   ...
                   <td>
                    <?php echo anchor('backoffice_modification/ficheCours/'.$row->GMCO_CODE, lang('details'));?>
                    <?php echo anchor('backoffice_modification/modifierCours/'.$row->GMCO_CODE, lang('modify'));?>
                      <?php
                        $attr = array(
                                      'onclick'=>'return confirmDialog();'
                                      );
                        echo anchor('backoffice_liste/deleteCours/'.$row->GMCO_CODE, lang('delete'),$attr);
                      ?>
        ...
        <?php 
          ...
          {
            echo form_open('backoffice_liste/listeCours');
