...
<html lang="en">
  ...
  <body>
    ...
    <?php echo form_open('backoffice_liste/recherche_procedure_administrative');?>
    ...
    <div class ="ajout_element">
      <?php echo anchor("backoffice_ajout/ajouterProcedure",'<span class="btn btn-danger"><span class="glyphicon glyphicon-plus"></span> '.lang('procedure_administrative_new').'</span>');?> 
    </div>
       ...
       <div class="panel-body">
        ...
        <?php 
          ...
          {
            echo form_open('Backoffice_liste/list_procedure_admin');
