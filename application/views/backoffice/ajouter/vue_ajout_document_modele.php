<html>
  <head>
    ...
    <title>
      <?php echo lang('add_document_modele');?>
    </title>
  </head>
    ...
    <body>
      ...
      <div id="Message">
        <h2>
          <?php echo lang('create_document_modele') ;?>
        </h2>
      </div>


    <?php echo form_open_multipart('backoffice_ajout/ajouter_document_modele');?>
