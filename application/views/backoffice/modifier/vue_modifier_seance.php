<html>
  <head>
      ...
      <title>
          <?php echo sprintf(lang('modify_seance'),$seance->GMSEA_DATE.' '.$seance->GMCO_NOM);?>
      </title>
    </head>
    ...
    <?php echo form_open('backoffice_modification/editSeance');?>
<div id="div_modify_seance">
    <p>
        <?php $defaut = array('name'=>'GMSEA_CODE',
                          'id'=>'GMSEA_CODE',
                          'size'=>'50',
                          'value'=>$seance->GMSEA_CODE,
    ...
    <p>
      ...
      if ($seance->GMPL_CODE != NULL ) 
      {
        echo form_dropdown('GMPL_CODE',$plannings,$seance->GMPL_CODE, $defaut);
    ...
    <p>
      <?php $defaut = 'id="GMCO_CODE" name="GMCO_CODE" placeholder="'.lang('val_cours').'"  class = "form-control" size = "1"'; 
          ...
          if ($seance->GMCO_CODE != NULL ) 
          {
            echo form_dropdown('GMCO_CODE',$cours,$seance->GMCO_CODE, $defaut);
    ...
    <p>
        ...
        if ($seance->GMSEA_TYPE != NULL ) 
        {
          echo form_dropdown('GMSEA_TYPE',$seance_type,$seance->GMSEA_TYPE,$defaut);
          
        }
        else 
        {
           echo form_dropdown('GMSEA_TYPE',$seance_type,set_value('GMSEA_TYPE') ,$defaut);
        }
        if(!empty($error_type_seance))
          {
    ...
    <p>
        <?php $defaut = array('name'=>'GMSEA_JOUR',
                          'id'=>'GMSEA_JOUR',
                          'size'=>'50',
                          'value'=>$seance->GMSEA_JOUR,
                          'placeholder'=> lang('val_jour'),
                          'class' => 'form-control',
                          'readonly'=>'true'
                          ); 
          $error_date=form_error('GMSEA_DATE');
    ...
    <p>
        <?php $defaut = array('name'=>'GMSEA_HEURE_DEBUT',
                          ...
                          'size'=>'4',
                          'class' => 'form-control',
                          'value' => str_split($seance->GMSEA_HEURE_DEBUT,5)[0]
                           ); 
    ...
    <p>
        <?php $defaut = array('name'=>'GMSEA_HEURE_FIN',
                          ...
                          'size'=>'4',
                          'class' => 'form-control',
                          'value' => str_split($seance->GMSEA_HEURE_FIN,5)[0]
                          ); 
    ...
    <p>
       <?php $statut = array(
        ...
        if ($seance->GMSEA_STATUT != NULL ) 
        {
          echo form_dropdown('GMSEA_STATUT',$statut,$seance->GMSEA_STATUT, $defaut);
    ...
    <p>
      <?php $defaut = 'id="GMSA_CODE" name="GMSA_CODE" placeholder="'.lang('val_salle').'"  class = "form-control" size = "1"'; 
        ...
        if ($seance->GMSA_CODE != NULL ) 
        {
          echo form_dropdown('GMSA_CODE',$salles,$seance->GMSA_CODE, $defaut);
    ...
    <p>
        <?php $defaut = array('name'=>'GMSEA_INFOS_COMPLEMENTAIRES',
                          ...
                          'size'=>'1000',
                          'class' => 'form-control',
                          'value' => $seance->GMSEA_INFOS_COMPLEMENTAIRES
                          ); 
    ...
    <div id="div_modify_seance_buttons" class="btn-group" role="group">
