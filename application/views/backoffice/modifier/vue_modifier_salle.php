<html>
  <head>
      ...
      <title>
          <?php echo sprintf(lang('modify_salle'),$salle->GMSA_NOM)?>
      </title>
    </head>
    ...
    <?php echo form_open('backoffice_modification/editSalle');?>
<div id="div_modify_salle">
    <p>
        <?php $defaut = array('name'=>'GMSA_CODE',
                          'id'=>'GMSA_CODE',
                          'size'=>'50',
                          'value'=>$salle->GMSA_CODE,
    ...
    <div id="div_modify_salle_buttons" class="btn-group" role="group">
