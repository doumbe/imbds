...
<?php 
	...
	echo anchor("candidat_c/candidature_fiche_informations_resume/".$candidat->GMCA_CODE.'/','Information personnelle',$fiche);
?>
</li>
<li class="page_item page-item-4">
<?php 
	...
	echo anchor("candidat_c/candidature_suivi_dossier/".$candidat->GMCA_CODE.'/','Suivre mon dossier',$fiche);
?>
</li>
<li class="page_item page-item-4">
<?php 
