   ...
   <body>
    ...
    <div id = 'page'>
      ...
      <div id = 'contenu'>
        ...
        <?php echo form_open_multipart('intervenant_modification/edit_document_attache_vacation');?>
                  ...
                  <?php
                    ...
                    $other = array(
                     ...
                     if(!is_null($document_attache->GMDA_DOCUMENT)){
                      if($document_attache->GMDA_FORMAT=="zip" or $document_attache->GMDA_FORMAT=="rar")
                      {
                        echo anchor(base_url().$document_attache->GMDA_DOCUMENT,'<img class="th_logo" src="'.base_url().'images/logo/rar.png"/>',$other);
                      }
