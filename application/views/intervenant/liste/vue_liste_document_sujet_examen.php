...
<html lang="en">
      ...
      <div id = 'contenu'>
       <?php $this->load->view('intervenant/menu.php');?>
        ...
        <div id = 'content' class = 'narrowcolumn'>
          ...
          <div id="message">
            <h2><?php echo lang("depot_sujet_title");?></h2>
        </div>

    <div class ="recherche">
    <?php echo form_open('intervenant_list/recherche_document_examen');?>
  ...
  <br/><br/>
    <div class ="ajout_element">
      <?php echo anchor("intervenant_ajout/ajouter_document_examen",'<span class="btn btn-danger"><span class="glyphicon glyphicon-plus"></span> '.lang('document_examen_new').'</span>');?> 
    </div>
    ...
    <div class="panel-body">
    	<div class="table-responsive">
    		...
    		<table class="table table-bordered">
    			...
    			<caption>
            <h4><?php echo lang("document_examen_list");?></h4>
            </caption>
            <thead>
              <tr>
            ...
            <tbody>
               <?php 
                ...
                <?php if($row->GMDA_TYPE == "CC" or $row->GMDA_TYPE == "cc" or $row->GMDA_TYPE == "CT" or $row->GMDA_TYPE == "ct"){?>
                <tr>
                  <td class="table_left table_vertical_center"><?php echo $row->GMDA_ANNEE;?></td>
                   ...
                   <td class="table_vertical_center">
                      <?php echo anchor('intervenant_modification/fiche_document_examen/'.$row->GMDA_CODE, lang('details'));?>
                      <?php echo anchor('intervenant_modification/modifier_document_examen/'.$row->GMDA_CODE, lang('modify'));?>
                      <?php 
                        $attr = array(
                                      'onclick'=>'return confirmDialog();'
                                      );
                        echo anchor('intervenant_list/delete_document_cours/'.$row->GMDA_CODE, lang('delete'),$attr);
                      ?>
    	...
    	<div id="message_alerte">
          <?php if(empty($document_attache)){ echo lang('no_document_cours');}?>
        </div>
        <!-- /.table-responsive -->
        <?php 
          if(isset($link))
          ...
          {
            echo form_open('intervenant_list/list_document_sujet_examen');
