...
<html lang="en">
    ...
    <div id = 'page'>
      ...
      <div id = 'contenu'>
        ...
        <div id = 'content' class = 'narrowcolumn'>
          ...
          <div id="message">
            <h2><?php echo lang("depot_cours_title");?></h2>
        </div>

    <div class ="recherche">
    <?php echo form_open('intervenant_list/recherche_document_cours');?>
  ...
  <br/><br/>
    <div class ="ajout_element">
      <?php echo anchor("intervenant_ajout/ajouter_document_cours",'<span class="btn btn-danger"><span class="glyphicon glyphicon-plus"></span> '.lang('document_cours_new').'</span>');?> 
    </div>
    ...
    <div class="panel-body">
    	<div class="table-responsive">
    		...
    		<table class="table table-bordered">
    			...
    			<caption>
            <h4><?php echo lang("document_cours_list");?></h4>
            </caption>
            <thead>
              <tr>
            ...
            <tbody>
               <?php 
                ...
                <?php if($row->GMDA_TYPE == "COURS" or $row->GMDA_TYPE == "cours"){?>
                <tr>
                  <td class="table_left table_vertical_center"><?php echo $row->GMDA_ANNEE;?></td>
                   ...
                   <td class="table_vertical_center">
                      <?php echo anchor('intervenant_modification/fiche_document_cours/'.$row->GMDA_CODE, lang('details'));?>
                      <?php echo anchor('intervenant_modification/modifier_document_cours/'.$row->GMDA_CODE, lang('modify'));?>
                      <?php 
                        $attr = array(
        ...
        <?php 
          ...
          {
            echo form_open('intervenant_list/list_document_cours');
