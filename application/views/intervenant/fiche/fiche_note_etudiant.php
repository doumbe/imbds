    ...
    <div id = 'page'>
      ...
      <div id = 'contenu'>
        ...
        <div id = 'content' class = 'narrowcolumn'>
          ...
          <div id="message">
            <h2> <?php echo sprintf(lang('fiche_document_cours'),$note_etudiant->GMET_NOM, $note_etudiant->GMET_PRENOM);?></h2>
          </div>
          <div id="div_fiche_document_modele" class="bloc_info">
          <p> <?php echo '<label>'.lang('nom_param').'</label><span id="fiche_document_modele_nom">'.$note_etudiant->GMNO_CONTROLE_CONTINU.'</span>';?>
          </p>
          <p> <?php echo '<label>'.lang('type_doc').'</label><span id="fiche_document_modele_type">'.$note_etudiant->GMNO_PROJET.'</span>';?></p>
          <p> <?php echo '<label>'.lang('format').'</label><span id="fiche_document_modele_format">'.$note_etudiant->GMNO_FINALE.'</span>';?></p>
          <p> <?php echo '<label>'.lang('annee').'</label><span id="fiche_document_modele_annee">'.$note_etudiant->GMNO_EXAMEN.'</span>';?></p>
          <!--
