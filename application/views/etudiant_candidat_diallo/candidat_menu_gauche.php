...
<?php 
	...
	echo anchor("candidat_c/page_accueil_site/".$candidat->GMCA_CODE.'/',lang('candidat_Acceuil'),$fiche); //GMCA160011
?>
</li>
<li class="page_item page-item-4">
<?php 
...
<?php 
	...
	echo anchor("candidat_c/candidature_suivi_dossier/".$candidat->GMCA_CODE.'/',lang('Suivre son dossier'),$fiche);
?>
</li>
