<?php 
	Class note_m extends CI_Model
	{
		...
		public function getNotesMatieresByEtudiant($id_etudiant) {
			return $this->db->distinct()->select('gmma_code_apogee, gmue_code, gmma_nom, gmnoma_note_finale')->from('GMMatiere')->join('GM_note_matiere','GM_note_matiere.gmma_code = GMMatiere.gmma_code')->where(array('GMET_CODE'=>$id_etudiant))->get()->result();
		}
